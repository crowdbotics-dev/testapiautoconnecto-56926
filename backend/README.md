...
## Project Structure
    ...
    ├── testapiautoconnecto_56926  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_56926`
...
2. Clone this repo and `cd testapiautoconnecto_56926`
